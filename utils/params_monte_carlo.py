...
def print_stars_(title: str = None, n: int = 70) -> None:
    """
...
def error_abort_(msg: str = "error, aborting"):
    """
    ...
    """
    print_stars_(f"{name_func_(3)}: {msg}")
    sys.exit(1)


def mkdir_if_needed_(p: Union[Path, str]) -> Path:
    """
...
monte_carlo_dir = mkdir_if_needed_(
